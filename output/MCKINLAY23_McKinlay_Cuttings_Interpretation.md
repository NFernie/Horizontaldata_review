...
| Sample Descriptions | `McKinlay 23 Hz Section Samples Descriptions.xlsx` (Input Sheet) | Depth intervals & sample properties |
...
**Excluded zones (±10 m around overburden & target re-entry tops):** 1669–1689 (target_reentry)

**Samples in McKinlay Member:** 180 of 197 total
...
| RES_SHALLOW (ohm.m) | 43.03 | 32 |
| **Δ Res (Deep − Shallow)** | **8.40** | — |
...
| RES_SHALLOW (ohm.m) | 44.19 | 33 |
| **Δ Res (Deep − Shallow)** | **12.85** | — |
...
| RES_SHALLOW (ohm.m) | 37.51 | 32 |
| **Δ Res (Deep − Shallow)** | **3.05** | — |
...
| Metric | Value |
|--------|-------|
| Intervals analysed | 180 |
| Depth range | 1695 – 2590 m |
| Avg % Sandstone | 98.4% |
| Avg Δ Res (Deep−Shallow) | 2.14 ohm.m |
| Max Δ Res | 12.85 ohm.m |
| Min Δ Res | -1.13 ohm.m |
| Mudlog matches | 78 / 180 |
