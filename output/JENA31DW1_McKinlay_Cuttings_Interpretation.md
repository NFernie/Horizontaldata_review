...
**Generated:** 2026-07-07 04:14 UTC  
...
|-------|---------|-------------|
| GR (gAPI) | 63.7 | 33 |
| RES_DEEP (ohm.m) | 53.36 | 33 |
| RES_SHALLOW (ohm.m) | 39.83 | 33 |
| **Δ Res (Deep − Shallow)** | **13.53** | — |
...
| Avg % Sandstone | 89.3% |
| Avg Δ Res (Deep−Shallow) | 2.37 ohm.m |
| Max Δ Res | 16.66 ohm.m |
| Min Δ Res | 0.05 ohm.m |
