...
|-----------------------|-------------|-------|-----------------|-----------------|
| 1934.99 | 1936.48 | 1.49 | 1984.99 (assumed +50 m) | 50.0 | (3 entry pairs: 1934.99, 2041.92, 2334.51)

**McKinlay Member analysis window:** 1685.7 – 2500.0 m MD

**Excluded overburden intervals (entry → re-entry, pay resumes at re-entry):** 1935–1985 m (overburden)

**Samples in McKinlay Member:** 88 of 111 total
- Excluded pre-reservoir: 17
- Excluded overburden intervals: 6
...
|-------|---------|-------------|
| GR (gAPI) | 26.4 | 19 |
| RES_DEEP (ohm.m) | 22.56 | 19 |
| RES_SHALLOW (ohm.m) | 30.10 | 19 |
...
|-------|---------|-------------|
| GR (gAPI) | 28.9 | 20 |
| RES_DEEP (ohm.m) | 26.24 | 20 |
| RES_SHALLOW (ohm.m) | 31.90 | 20 |
...
|-------|---------|-------------|
| GR (gAPI) | 25.2 | 19 |
| RES_DEEP (ohm.m) | 25.18 | 19 |
| RES_SHALLOW (ohm.m) | 25.80 | 19 |
...
|-------|---------|-------------|
| GR (gAPI) | 25.9 | 20 |
| RES_DEEP (ohm.m) | 26.11 | 20 |
| RES_SHALLOW (ohm.m) | 26.00 | 20 |
...
|-------|---------|-------------|
| GR (gAPI) | 26.5 | 20 |
| RES_DEEP (ohm.m) | 25.97 | 20 |
| RES_SHALLOW (ohm.m) | 26.84 | 20 |
...
|-------|---------|-------------|
| GR (gAPI) | 24.5 | 19 |
| RES_DEEP (ohm.m) | 23.85 | 19 |
| RES_SHALLOW (ohm.m) | 25.11 | 19 |
...
|-------|---------|-------------|
| GR (gAPI) | 23.6 | 20 |
| RES_DEEP (ohm.m) | 22.18 | 20 |
| RES_SHALLOW (ohm.m) | 24.99 | 20 |
...
|-------|---------|-------------|
| GR (gAPI) | 22.9 | 20 |
| RES_DEEP (ohm.m) | 20.89 | 20 |
| RES_SHALLOW (ohm.m) | 24.45 | 20 |
...
|-------|---------|-------------|
| GR (gAPI) | 21.7 | 20 |
| RES_DEEP (ohm.m) | 20.48 | 20 |
| RES_SHALLOW (ohm.m) | 22.82 | 20 |
...
|-------|---------|-------------|
| GR (gAPI) | 22.2 | 20 |
| RES_DEEP (ohm.m) | 20.58 | 20 |
| RES_SHALLOW (ohm.m) | 23.55 | 20 |
...
|-------|---------|-------------|
| GR (gAPI) | 22.0 | 19 |
| RES_DEEP (ohm.m) | 20.25 | 19 |
| RES_SHALLOW (ohm.m) | 23.61 | 19 |
...
|-------|---------|-------------|
| GR (gAPI) | 22.2 | 20 |
| RES_DEEP (ohm.m) | 20.83 | 20 |
| RES_SHALLOW (ohm.m) | 23.61 | 20 |
...
|-------|---------|-------------|
| GR (gAPI) | 23.3 | 29 |
| RES_DEEP (ohm.m) | 22.75 | 29 |
| RES_SHALLOW (ohm.m) | 24.22 | 29 |
...
|-------|---------|-------------|
| GR (gAPI) | 24.9 | 53 |
| RES_DEEP (ohm.m) | 24.58 | 53 |
| RES_SHALLOW (ohm.m) | 25.32 | 53 |
...
|-------|---------|-------------|
| GR (gAPI) | 26.1 | 65 |
| RES_DEEP (ohm.m) | 26.09 | 65 |
| RES_SHALLOW (ohm.m) | 26.33 | 65 |
...
|-------|---------|-------------|
| GR (gAPI) | 21.2 | 66 |
| RES_DEEP (ohm.m) | 20.33 | 66 |
| RES_SHALLOW (ohm.m) | 22.36 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 26.6 | 65 |
| RES_DEEP (ohm.m) | 26.14 | 65 |
| RES_SHALLOW (ohm.m) | 27.40 | 65 |
...
|-------|---------|-------------|
| GR (gAPI) | 33.3 | 66 |
| RES_DEEP (ohm.m) | 33.27 | 66 |
| RES_SHALLOW (ohm.m) | 33.81 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 24.6 | 65 |
| RES_DEEP (ohm.m) | 24.27 | 65 |
| RES_SHALLOW (ohm.m) | 25.40 | 65 |
...
|-------|---------|-------------|
| GR (gAPI) | 28.5 | 66 |
| RES_DEEP (ohm.m) | 28.02 | 66 |
| RES_SHALLOW (ohm.m) | 29.74 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 20.8 | 66 |
| RES_DEEP (ohm.m) | 20.18 | 66 |
| RES_SHALLOW (ohm.m) | 21.57 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 26.4 | 65 |
| RES_DEEP (ohm.m) | 25.97 | 65 |
| RES_SHALLOW (ohm.m) | 26.86 | 65 |
...
|-------|---------|-------------|
| GR (gAPI) | 32.1 | 66 |
| RES_DEEP (ohm.m) | 31.58 | 66 |
| RES_SHALLOW (ohm.m) | 32.37 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 38.5 | 66 |
| RES_DEEP (ohm.m) | 37.72 | 66 |
| RES_SHALLOW (ohm.m) | 39.41 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 42.7 | 66 |
| RES_DEEP (ohm.m) | 40.46 | 66 |
| RES_SHALLOW (ohm.m) | 43.82 | 66 |
| **Δ Res (Deep − Shallow)** | **-3.36** | — |
...
|-------|---------|-------------|
| GR (gAPI) | 22.1 | 65 |
| RES_DEEP (ohm.m) | 21.61 | 65 |
| RES_SHALLOW (ohm.m) | 23.17 | 65 |
...
**Sample Description (spreadsheet):** Sample 2040m: 5% Siltstone, 95% very fine to fine Sandstone, 100% bright FLUOR in SST. TG 310U
...
|-------|---------|-------------|
| GR (gAPI) | 25.6 | 65 |
| RES_DEEP (ohm.m) | 23.11 | 65 |
| RES_SHALLOW (ohm.m) | 28.60 | 65 |
| **Δ Res (Deep − Shallow)** | **-5.49** | — |
...
**Sample Description (spreadsheet):** Sample 2050m: 5% Siltstone, 95% very fine to fine Sandstone, 90% moderately bright  to  bright FLUOR in SST. TG 323U
...
**Sample Description (spreadsheet):** Sample 2060m: 5% Siltstone, 95% very fine  to  coarse Sandstone, 100% moderately bright  to  bright FLUOR in SST. TG 360U
...
| RES_SHALLOW (ohm.m) | 34.74 | 65 |
| **Δ Res (Deep − Shallow)** | **-8.13** | — |
...
**Sample Description (spreadsheet):** Sample 2070m: 10% Siltstone, 90% very fine  to  coarse Sandstone, 90% moderately bright  to  bright FLUOR in SST. TG 213U
...
| RES_SHALLOW (ohm.m) | 29.14 | 66 |
| **Δ Res (Deep − Shallow)** | **-6.54** | — |
...
**Sample Description (spreadsheet):** Sample 2080m: 20% Siltstone, 80% very fine  to  coarse Sandstone, 80% moderately bright  to  bright FLUOR in SST. TG 209U
...
|-------|---------|-------------|
| GR (gAPI) | 22.4 | 65 |
| RES_DEEP (ohm.m) | 21.28 | 65 |
| RES_SHALLOW (ohm.m) | 24.02 | 65 |
...
|-------|---------|-------------|
| GR (gAPI) | 25.0 | 66 |
| RES_DEEP (ohm.m) | 23.87 | 66 |
| RES_SHALLOW (ohm.m) | 26.21 | 66 |
| **Δ Res (Deep − Shallow)** | **-2.34** | — |
...
|-------|---------|-------------|
| GR (gAPI) | 23.1 | 65 |
| RES_DEEP (ohm.m) | 21.94 | 65 |
| RES_SHALLOW (ohm.m) | 24.28 | 65 |
| **Δ Res (Deep − Shallow)** | **-2.34** | — |
...
|-------|---------|-------------|
| GR (gAPI) | 25.4 | 66 |
| RES_DEEP (ohm.m) | 23.52 | 66 |
| RES_SHALLOW (ohm.m) | 26.75 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 26.1 | 66 |
| RES_DEEP (ohm.m) | 24.90 | 66 |
| RES_SHALLOW (ohm.m) | 26.74 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 24.9 | 66 |
| RES_DEEP (ohm.m) | 23.16 | 66 |
| RES_SHALLOW (ohm.m) | 25.92 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 20.8 | 66 |
| RES_DEEP (ohm.m) | 20.10 | 66 |
| RES_SHALLOW (ohm.m) | 21.83 | 66 |
| **Δ Res (Deep − Shallow)** | **-1.72** | — |
...
|-------|---------|-------------|
| GR (gAPI) | 23.4 | 66 |
| RES_DEEP (ohm.m) | 22.00 | 66 |
| RES_SHALLOW (ohm.m) | 24.75 | 66 |
| **Δ Res (Deep − Shallow)** | **-2.74** | — |
...
|-------|---------|-------------|
| GR (gAPI) | 25.3 | 65 |
| RES_DEEP (ohm.m) | 23.47 | 65 |
| RES_SHALLOW (ohm.m) | 26.62 | 65 |
...
|-------|---------|-------------|
| GR (gAPI) | 23.3 | 65 |
| RES_DEEP (ohm.m) | 23.02 | 65 |
| RES_SHALLOW (ohm.m) | 23.72 | 65 |
...
|-------|---------|-------------|
| GR (gAPI) | 23.8 | 65 |
| RES_DEEP (ohm.m) | 23.64 | 65 |
| RES_SHALLOW (ohm.m) | 24.49 | 65 |
...
**Sample Description (spreadsheet):** Sample 2330m: 0% Siltstone, 100% very fine to medium Sandstone, 100% moderately bright  to  bright FLUOR in SST. TG 400U
...
|-------|---------|-------------|
| GR (gAPI) | 23.7 | 66 |
| RES_DEEP (ohm.m) | 22.55 | 66 |
| RES_SHALLOW (ohm.m) | 25.02 | 66 |
...
**Sample Description (spreadsheet):** Sample 2340m: 90% Siltstone, 10% very fine to medium Sandstone, 100% moderately bright  to  bright FLUOR in SST. TG 105U
...
**Sample Description (spreadsheet):** Sample 2350m: Y siderite in 85% Siltstone, 15% very fine to fine Sandstone, NO FLUOR in SST. TG 115U
...
|-------|---------|-------------|
| GR (gAPI) | 14.7 | 65 |
| RES_DEEP (ohm.m) | 13.79 | 65 |
| RES_SHALLOW (ohm.m) | 15.94 | 65 |
...
**Sample Description (spreadsheet):** Sample 2360m: Y siderite in 85% Siltstone, 15% very fine to fine Sandstone, NO FLUOR in SST. TG 110U
...
|-------|---------|-------------|
| GR (gAPI) | 12.1 | 66 |
| RES_DEEP (ohm.m) | 11.30 | 66 |
| RES_SHALLOW (ohm.m) | 13.04 | 66 |
...
**Sample Description (spreadsheet):** Sample 2370m: 80% Siltstone, 20% very fine to fine Sandstone, NO FLUOR in SST. TG 81U
...
|-------|---------|-------------|
| GR (gAPI) | 11.3 | 65 |
| RES_DEEP (ohm.m) | 10.83 | 65 |
| RES_SHALLOW (ohm.m) | 11.91 | 65 |
...
**Sample Description (spreadsheet):** Sample 2380m: 70% Siltstone, 30% very fine to fine Sandstone, NO FLUOR in SST. TG 89U
...
|-------|---------|-------------|
| GR (gAPI) | 11.0 | 66 |
| RES_DEEP (ohm.m) | 10.66 | 66 |
| RES_SHALLOW (ohm.m) | 11.52 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 10.8 | 66 |
| RES_DEEP (ohm.m) | 10.60 | 66 |
| RES_SHALLOW (ohm.m) | 11.24 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 10.5 | 65 |
| RES_DEEP (ohm.m) | 10.33 | 65 |
| RES_SHALLOW (ohm.m) | 10.87 | 65 |
| **Δ Res (Deep − Shallow)** | **-0.54** | — |
...
|-------|---------|-------------|
| GR (gAPI) | 10.4 | 66 |
| RES_DEEP (ohm.m) | 10.33 | 66 |
| RES_SHALLOW (ohm.m) | 10.74 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 10.6 | 66 |
| RES_DEEP (ohm.m) | 10.43 | 66 |
| RES_SHALLOW (ohm.m) | 10.90 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 11.2 | 65 |
| RES_DEEP (ohm.m) | 11.01 | 65 |
| RES_SHALLOW (ohm.m) | 11.51 | 65 |
...
|-------|---------|-------------|
| GR (gAPI) | 12.1 | 66 |
| RES_DEEP (ohm.m) | 11.48 | 66 |
| RES_SHALLOW (ohm.m) | 12.79 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 13.3 | 65 |
| RES_DEEP (ohm.m) | 12.91 | 65 |
| RES_SHALLOW (ohm.m) | 13.87 | 65 |
...
|-------|---------|-------------|
| GR (gAPI) | 14.6 | 66 |
| RES_DEEP (ohm.m) | 14.44 | 66 |
| RES_SHALLOW (ohm.m) | 15.04 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 11.9 | 65 |
| RES_DEEP (ohm.m) | 11.72 | 65 |
| RES_SHALLOW (ohm.m) | 12.43 | 65 |
| **Δ Res (Deep − Shallow)** | **-0.71** | — |
...
|-------|---------|-------------|
| GR (gAPI) | 10.9 | 36 |
| RES_DEEP (ohm.m) | 10.31 | 36 |
| RES_SHALLOW (ohm.m) | 11.57 | 36 |
| **Δ Res (Deep − Shallow)** | **-1.27** | — |
...
| Metric | Value |
|--------|-------|
| Intervals analysed | 88 |
| Depth range | 1686 – 2500 m |
| Avg % Sandstone | 77.9% |
| Avg Δ Res (Deep−Shallow) | -2.22 ohm.m |
| Max Δ Res | 0.79 ohm.m |
| Min Δ Res | -8.13 ohm.m |
| Mudlog matches | 60 / 88 |
