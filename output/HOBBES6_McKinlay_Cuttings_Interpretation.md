...
|-----------------|-------------|-------|
| 1934.99 | 1936.48 | 1.49 |
| 2041.92 | 2041.92 | 0.00 |
| 2334.51 | 2332.00 | 2.51 |

**McKinlay Member analysis window:** 1685.7 – 2500.0 m MD

**Excluded zones (±10 m around overburden & target re-entry tops):** 1925–1945 (overburden), 2032–2052 (overburden), 2325–2345 (overburden), 1676–1696 (target_reentry)

**Samples in McKinlay Member:** 81 of 111 total
- Excluded pre-reservoir: 17
- Excluded overburden intersections: 9
- Excluded target re-entry tops: 4
...
**Sample Description (spreadsheet):** Sample 1950m: Y siderite in 70% Siltstone, 30% very fine to fine Sandstone, 80% moderately bright  to  bright FLUOR in SST. TG 128U
...
|-------|---------|-------------|
| GR (gAPI) | 21.1 | 66 |
| RES_DEEP (ohm.m) | 18.02 | 66 |
| RES_SHALLOW (ohm.m) | 24.54 | 66 |
...
**Sample Description (spreadsheet):** Sample 1960m: Y siderite in 90% Siltstone, 10% very fine to fine Sandstone, 80% moderately bright  to  bright FLUOR in SST. TG 118U
...
|-------|---------|-------------|
| GR (gAPI) | 20.1 | 65 |
| RES_DEEP (ohm.m) | 17.53 | 65 |
| RES_SHALLOW (ohm.m) | 22.92 | 65 |
...
**Sample Description (spreadsheet):** Sample 1970m: Y siderite in 80% Siltstone, 20% very fine to fine Sandstone, 80% moderately bright  to  bright FLUOR in SST. TG 137U
...
|-------|---------|-------------|
| GR (gAPI) | 29.2 | 66 |
| RES_DEEP (ohm.m) | 25.68 | 66 |
| RES_SHALLOW (ohm.m) | 32.76 | 66 |
...
|-------|---------|-------------|
| GR (gAPI) | 30.0 | 65 |
| RES_DEEP (ohm.m) | 27.53 | 65 |
| RES_SHALLOW (ohm.m) | 33.09 | 65 |
